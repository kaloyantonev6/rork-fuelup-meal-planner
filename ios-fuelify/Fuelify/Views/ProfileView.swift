...
struct ProfileView: View {
    ...
    private var header: some View {
        VStack(spacing: 8) {
            ...
            Text(profile.name.isEmpty ? "Fuelify Player" : profile.name)
            ...
            VStack(spacing: 0) {
                ...
                if notifications.authorizationDenied && profile.mealRemindersEnabled {
                    ...
                    HStack(spacing: 10) {
                        ...
                        Text("Notifications are turned off for Fuelify. Enable them in iOS Settings to get reminders.")
                            .font(.system(size: 12))
                            .foregroundStyle(Theme.textSecondary)
